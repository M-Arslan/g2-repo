...
import { validateAccountant } from './Validations/validateFinancial';
...
export const AccountingSelectionDrawer = ({ open, onClose, request, dispatch, formValidator, onNext }) => {
    ...
    const onNextClick = async () => {
        let isValid = await validateAccountant(formValidator.trigger);
        if (isValid) {
            onNext();
        }
    }
