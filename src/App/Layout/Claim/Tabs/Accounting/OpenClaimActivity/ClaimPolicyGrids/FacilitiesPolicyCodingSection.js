...
export const FacilitiesPolicyCodingSection = ({ request,policyID, onRowSelected }) => {
    ...
    const colDefs = [
        ...
        {
            headerName: 'Casualty Deductible',
            field: 'casualtyDeductible',
            valueFormatter: currencyFormatter,
            flex: 2,
        },
        {
            headerName: 'Property Deductible',
            field: 'propertyDeductible',
            valueFormatter: currencyFormatter,
            flex: 2,
        },
    ];
    ...
    const loadData = async () => {
        let query = {
            "query": `
            query {
                facilitiesPolicyCodings(policyID:"${policyID}"){ 
                    aggregateLimit
                    attachmentTypeCode
                    classCode
                    className
        ...
        let covereagesData = []
        covereagesData = result.data.facilitiesPolicyCodings || [];
