...
export const MedicalProfPolicyCodingSection = ({ request,policyID, onRowSelected }) => {
    ...
    const loadData = async () => {
        let query = {
            "query": `
            query {
                medicalProfPolicyCodings(policyID:"${policyID}"){ 
                    aggregateLimit
                    attachmentTypeCode
                    classCode
                    className
        ...
        let covereagesData = []
        covereagesData = result.data.medicalProfPolicyCodings || [];
