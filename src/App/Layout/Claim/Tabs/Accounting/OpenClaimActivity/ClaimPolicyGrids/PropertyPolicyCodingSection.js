...
export const PropertyPolicyCodingSection = ({ request,policyID, onRowSelected }) => {
    ...
    const loadData = async () => {
        let query = {
            "query": `
            query {
                propertyPolicyCodings(policyID:"${policyID}"){ 
                    aggregateLimit
                    attachmentTypeCode
                    classCode
                    className
        ...
        let covereagesData = []
        covereagesData = result.data.propertyPolicyCodings || [];
