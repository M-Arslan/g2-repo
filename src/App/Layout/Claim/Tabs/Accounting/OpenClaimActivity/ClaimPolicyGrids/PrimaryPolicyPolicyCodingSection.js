...
export const PrimaryPolicyPolicyCodingSection = ({ request,policyID, onRowSelected }) => {
    ...
    const loadData = async () => {
        let query = {
            "query": `
            query {
                primaryPolicyCodings(policyID:"${policyID}"){ 
                    aggregateLimit
                    attachmentTypeCode
                    classCode
                    className
        ...
        let covereagesData = []
        covereagesData = result.data.primaryPolicyCodings || [];
