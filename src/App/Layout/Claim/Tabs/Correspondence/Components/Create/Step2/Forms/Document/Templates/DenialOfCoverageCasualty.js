        ...
        <>
            <FieldContainer>
                <TextInput
                    ...
                    helperText={model.EmailAddress.helperText}
                    required
                />
            </FieldContainer>
            <FieldContainer>
            ...
            <FieldContainer>
                <TextInput
                    id="ClaimantNumber"
                    label="Claim Number"
                    value={model.ClaimantNumber.value}
                    onChange={model.handleUserInput}
                    onBlur={model.handleFinalizeInput}
                    maxLength="50"
                    error={model.ClaimantNumber.showError}
                    helperText={model.ClaimantNumber.helperText}
                    required
                />
            </FieldContainer>
            <FieldContainer>
            ...
            <FieldContainer>
                <SelectList
                    id="ClaimOrOccurrence"
                    name="ClaimOrOccurrence"
                    label="Claim Or Occurrence"
                    value={model.ClaimOrOccurrence.value}
                    onChange={model.handleFinalizeInput}
                    variant="outlined"
                    allowempty={false}
                    fullWidth={true}
                    error={model.ClaimOrOccurrence.showError}
                    helperText={model.ClaimOrOccurrence.error}
                    required
                >
            ...
            <FieldContainer>
                <TextInput
                    id="InsuredOrMatterName"
                    label="Insured Or Matter Name"
                    value={model.InsuredOrMatterName.value}
                    onChange={model.handleUserInput}
                    onBlur={model.handleFinalizeInput}
                    maxLength="100"
                    error={model.InsuredOrMatterName.showError}
                    helperText={model.InsuredOrMatterName.helperText}
                    required
                />
            </FieldContainer>
            <FieldContainer>
                <TextInput
                    id="PotentiallyApplicableCoverage"
                    label="Potentially Applicable Coverage"
                    value={model.PotentiallyApplicableCoverage.value}
                    onChange={model.handleUserInput}
                    onBlur={model.handleFinalizeInput}
                    maxLength="5000"
                    multiline={true}
                    rows={8}
                    error={model.PotentiallyApplicableCoverage.showError}
                    helperText={model.PotentiallyApplicableCoverage.helperText}
                    required
                />
            </FieldContainer>
            <FieldContainer>
            ...
            <FieldContainer>
                <TextInput
                    id="CoveragePositionWording"
                    label="Coverage Position Wording"
                    value={model.CoveragePositionWording.value}
                    onChange={model.handleUserInput}
                    onBlur={model.handleFinalizeInput}
                    maxLength="5000"
                    multiline={true}
                    rows={8}
                    error={model.CoveragePositionWording.showError}
                    helperText={model.CoveragePositionWording.helperText}
                    required
                />
            </FieldContainer>
            <FieldContainer>
                <TextInput
                    id="PolicyProvisionsDiscussion"
                    label="Policy Provisions Discussion"
                    value={model.PolicyProvisionsDiscussion.value}
                    onChange={model.handleUserInput}
                    onBlur={model.handleFinalizeInput}
                    maxLength="5000"
                    multiline={true}
                    rows={8}
                    error={model.PolicyProvisionsDiscussion.showError}
                    helperText={model.PolicyProvisionsDiscussion.helperText}
                    required
                />
            </FieldContainer>
            <FieldContainer>
...
schema.bindProperty('EmailAddress', [Required, Email, MaxLength(255)])
    ...
    .bindProperty('ClaimantNumber', [Required, MaxLength(50)])
    ...
    .bindProperty('LineOfBusiness', [Required, MaxLength(100)])
    ...
    .bindProperty('ClaimOrOccurrence', [Required])
    ...
    .bindProperty('PotentiallyApplicableCoverage', [Required])
    ...
    .bindProperty('CoveragePositionWording', [Required])
    .bindProperty('InsuredOrMatterName', [Required, MaxLength(100)])
    .bindProperty('PolicyProvisionsDiscussion', [Required])
    .bindProperty('StateSpecificLanguage', [])
    .bindProperty('ExaminerName', [Required, MaxLength(100)])
...
export const CasualtyDenialOfCoverageForm = asForm(CasualtyDenial, schema);

/**
 * @typedef {object} DataProps
 * @property {import('../../../../../../../../../../Core/State/slices/claim/types.d').ClaimMaster} claim
 * @property {object} email
 * @property {Array<import('../../../../../../../../../../Core/State/slices/metadata/risk-states/types.d').RiskState>} states
 * @property {Array<import('../../../../../../../../../../Core/State/slices/metadata/template-text/types.d').TemplateText>} texts
 */

/**
 * 
 * @param {object} existingVal
 * @param {DataProps} dataContext
 */
export const getCasualtyDenialData = (existingVal, dataContext) => {
    ...
    const ssTextTemplate = (TEMPLATE_TEXT.hasOwnProperty(`PDOC_STATE_${defState}`) ? texts.find(t => t.templateTextID === TEMPLATE_TEXT[`PDOC_STATE_${defState}`]).text : '');
    ...
    const defaults = {
        ...
        AreOrAreNot: '',
        RetroactiveDate: '',
        PotentiallyApplicableCoverage: '',
        CoverageSection: '',
        ExclusionsSection: '',
        DamagesSection: '',
        OtherRelevantSections: '',
        CoveragePositionWording: '',
        InsuredOrMatterName: '',
        PolicyProvisionsDiscussion: '',
        StateSpecificLanguage: safeStr(ssText),
