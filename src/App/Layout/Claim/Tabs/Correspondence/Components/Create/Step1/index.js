...
const Step1Page = ({ id, state, onRequestStateUpdate, onAllowNextChanged  }) => {
...
export const Step1 = asWizardPage(Step1Page, { title: 'Data Entry', backEnabled: false, nextEnabled: false });
