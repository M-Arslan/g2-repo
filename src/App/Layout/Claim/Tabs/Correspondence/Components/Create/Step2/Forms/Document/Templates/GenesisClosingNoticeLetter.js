 ...
 */
const GenesisClosingNoticeLetter = ({ model }) => {
...
export const GenesisClosingNoticeLetterForm = asForm(GenesisClosingNoticeLetter, schema);

export const getGenesisClosingNoticeLetterData = (existing, dataContext) => {
