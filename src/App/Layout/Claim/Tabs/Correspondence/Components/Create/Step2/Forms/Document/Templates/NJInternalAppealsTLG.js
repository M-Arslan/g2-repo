 ...
 */
const NJNoticeOfInternalAppealsTLG = ({ model }) => {

    const setCompanyFields = (evt) => {
        const { value } = evt.target;

        if (ensureNonEmptyString(value)) {
            model.handleFinalizeInput(makeEvent('Company', (value === 'GSNIC' ? 'General Star National Insurance Company' : (value === 'GSIC' ? 'General Star Indemnity Company' : ''))));
        ...
        <>
            ...
            <FieldContainer>
                <SelectList
                    ...
                    required
                >
                    <MenuItem value="GSNIC">General Star National Insurance Company</MenuItem>
                    <MenuItem value="GSIC">General Star Indemnity Company</MenuItem>
                </SelectList>
            </FieldContainer>
            <FieldContainer>
                <TextInput
...
export const NJNoticeOfInternalAppealsTLGForm = asForm(NJNoticeOfInternalAppealsTLG, schema);
 ...
 * @param {any} email
 */
export const getNJNoticeOfInternalAppealsTLGData = (existingVal, dataContext) => {
