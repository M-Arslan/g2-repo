/**
 * @typedef {object} IsoCountry
 * @property {string} name country name
 * @property {string} alpha3 the ISO Alpha-3 code
 * @property {string} code the ISO numeric country code
 */

/** @type {Array<IsoCountry>} */
export const Countries = Object.freeze([
    ...
    { name: "Bolivia", alpha3: "BOL", code: "068" },
    { name: "Bonaire, Sint Eustatius and Saba", alpha3: "BES", code: "535" },
    ...
    { name: "British Indian Ocean Territory", alpha3: "IOT", code: "086" },
    ...
    { name: "Congo (Democratic Republic of)", alpha3: "COD", code: "180" },
    ...
    { name: "Falkland Islands (Malvinas)", alpha3: "FLK", code: "238" },
    ...
    { name: "French Southern Territories", alpha3: "ATF", code: "260" },
    ...
    { name: "Heard Island and McDonald Islands", alpha3: "HMD", code: "334" },
    ...
    { name: "Korea (North)", alpha3: "PRK", code: "408" },
    { name: "Korea (South)", alpha3: "KOR", code: "410" },
    { name: "Kuwait", alpha3: "KWT", code: "414" },
    { name: "Kyrgyzstan", alpha3: "KGZ", code: "417" },
    { name: "Lao People's Democratic Republic", alpha3: "LAO", code: "418" },
    ...
    { name: "Micronesia (Federated States of)", alpha3: "FSM", code: "583" },
    ...
    { name: "Saint Helena, Ascension and Tristan da Cunha", alpha3: "SHN", code: "654" },
    { name: "Saint Kitts and Nevis", alpha3: "KNA", code: "659" },
    { name: "Saint Lucia", alpha3: "LCA", code: "662" },
    { name: "Saint Maarten (Dutch)", alpha3: "SXM", code: "534" },
    { name: "Saint Martin (French)", alpha3: "MAF", code: "663" },
    { name: "Saint Pierre and Miquelon", alpha3: "SPM", code: "666" },
    { name: "Saint Vincent and the Grenadines", alpha3: "VCT", code: "670" },
    ...
    { name: "South Georgia and the South Sandwich Islands", alpha3: "SGS", code: "239" },
    ...
    { name: "Taiwan, Province of China", alpha3: "TWN", code: "158" },
    { name: "Tajikistan", alpha3: "TJK", code: "762" },
    { name: "Tanzania, United Republic of", alpha3: "TZA", code: "834" },
    ...
    { name: "United Kingdom", alpha3: "GBR", code: "826" },
    { name: "United States", alpha3: "USA", code: "840" },
    { name: "US Minor Outlying Islands", alpha3: "UMI", code: "581" },
    { name: "Uruguay", alpha3: "URY", code: "858" },
    { name: "Uzbekistan", alpha3: "UZB", code: "860" },
    { name: "Vanuatu", alpha3: "VUT", code: "548" },
    { name: "Venezuela", alpha3: "VEN", code: "862" },
    { name: "Vietnam", alpha3: "VNM", code: "704" },
